...
const appCss = "/assets/styles-ui2ppqFi.css";
...
const dict = {
  it: {
    ...
    home_students_body: "Materiali, lezioni, calcolatori e formulari per studiare la navigazione, la statica della nave e l'astronomia nautica. Tutto raccolto in un unico posto.",
    ...
    home_intro_body: "Portfolio professionale di ricerca e didattica nel settore della navigazione marittima, dei sistemi GNSS e della sostenibilità dei trasporti.",
    explore: "Esplora le sezioni",
    about_title: "Chi Sono",
    about_lead: "Ricercatore presso la Fondazione Institute for Sustainable Society and Innovation (ISSNOVA) e docente di Navigazione.",
    about_p1: "Sono ricercatore presso la Fondazione Institute for Sustainable Society and Innovation (ISSNOVA) e docente di Navigazione. Ho conseguito la Laurea Magistrale (con lode) in Scienze e Tecnologie della Navigazione all'Università degli Studi di Napoli «Parthenope», con specializzazione in MASS — Maritime Autonomous Surface Ships e navigazione a rotta adattiva.",
    about_p2: "Nel percorso accademico ho acquisito competenze avanzate in: elaborazione dati GNSS, telerilevamento, navigazione inerziale e sensor fusion. Ho partecipato a diversi progetti europei nel settore marittimo.",
    skills_label: "Competenze",
    research_title: "Aree di Ricerca",
    research_lead: "Tre filoni che orientano il mio lavoro accademico e applicato: navigazione autonoma, sostenibilità del trasporto marittimo e integrazione dei dati di posizionamento.",
    research_mass_title: "MASS — Navi Autonome di Superficie",
    research_mass_body: "Navigazione autonoma di superficie e rotta adattiva per il trasporto marittimo del futuro. Studio dei sistemi di percezione, decisione e controllo per imbarcazioni autonome.",
    research_sus_title: "Sostenibilità del Trasporto Marittimo",
    research_sus_body: "Efficienza ambientale, riduzione delle emissioni e performance navale. Approccio integrato a tecnologia, normativa e operatività.",
    research_gnss_title: "GNSS & Sensor Fusion",
    research_gnss_body: "Elaborazione dati di posizionamento, telerilevamento e integrazione inerziale. Algoritmi di fusione sensoriale per la navigazione robusta.",
    projects_title: "Progetti Europei",
    projects_lead: "Partecipazione a progetti Horizon Europe nel cluster Climate, Energy and Mobility (CL5) per il trasporto marittimo a impatto zero.",
    ...
    teaching_body: "Docente di Navigazione presso un Istituto Tecnico Trasporti e Logistica (ITTL). In questo spazio condivido materiali, lezioni e calcolatori interattivi sviluppati per gli studenti.",
    teaching_intro_short: "Materiali, lezioni e calcolatori interattivi per la didattica della navigazione, della statica della nave e dell'idrostatica.",
    teaching_subjects: "Materie & Aree",
    teaching_materials_title: "Materiali & Lezioni",
    teaching_materials_lead: "Schede, dispense, esercizi e prove organizzati per argomento. Clicca su un elemento per aprire o scaricare.",
    teaching_lessons_lead: "Slide e presentazioni usate in aula, divise per argomento. Materiale di riferimento per seguire le lezioni e ripassare i concetti chiave.",
    teaching_notes_lead: "Appunti sintetici, schemi e mappe concettuali per studiare e ripassare in autonomia, organizzati per argomento.",
    teaching_exercises_title: "Esercitazioni",
    teaching_exercises_lead: "Compiti, esercizi guidati e giochi didattici per mettere in pratica gli argomenti studiati, divisi per argomento.",
    ...
    teaching_calc_lead: "Applicazioni web sviluppate per la didattica: si aprono direttamente nel browser, senza installazione.",
    teaching_open: "Apri",
    ...
    teaching_formulari_lead: "Raccolta di formule essenziali per la navigazione, la statica della nave e l'astronomia nautica.",
    education_title: "Formazione",
    education_lead: "Percorso accademico all'Università degli Studi di Napoli «Parthenope» e formazione avanzata in gestione ambientale.",
    ...
    affiliation_body: "ISSNOVA — Fondazione Institute for Sustainable Society and Innovation. Ricercatore in sostenibilità dei trasporti.",
    bio_card_title: "Bio",
    lang_switch: "EN"
  },
  en: {
    ...
    home_students_body: "Materials, lessons, calculators and formularies to study navigation, ship statics and celestial astronomy. All gathered in one place.",
    ...
    home_intro_body: "Professional portfolio of research and teaching in maritime navigation, GNSS systems, and transport sustainability.",
    explore: "Explore the sections",
    about_title: "About Me",
    about_lead: "Researcher at the Fondazione Institute for Sustainable Society and Innovation (ISSNOVA) and Navigation teacher.",
    about_p1: "I am a researcher at the Fondazione Institute for Sustainable Society and Innovation (ISSNOVA) and a Navigation teacher. I earned my M.Sc. (cum laude) in Navigation Sciences and Technologies at the University of Naples «Parthenope», specializing in MASS — Maritime Autonomous Surface Ships and adaptive routing.",
    about_p2: "My academic path covers GNSS data processing, remote sensing, inertial navigation, and sensor fusion. I have contributed to several European research projects in the maritime sector.",
    skills_label: "Skills",
    research_title: "Research Areas",
    research_lead: "Three pillars guide my academic and applied work: autonomous navigation, sustainability of maritime transport, and integration of positioning data.",
    research_mass_title: "MASS — Maritime Autonomous Surface Ships",
    research_mass_body: "Autonomous surface navigation and adaptive routing for the maritime transport of the future. Perception, decision and control systems for autonomous vessels.",
    research_sus_title: "Maritime Transport Sustainability",
    research_sus_body: "Environmental efficiency, emissions reduction and vessel performance. An integrated approach across technology, regulation and operations.",
    research_gnss_title: "GNSS & Sensor Fusion",
    research_gnss_body: "Positioning data processing, remote sensing and inertial integration. Sensor-fusion algorithms for robust navigation.",
    projects_title: "European Projects",
    projects_lead: "Participation in Horizon Europe projects under the Climate, Energy and Mobility cluster (CL5) for zero-impact maritime transport.",
    status_active: "Ongoing",
    eu_horizon: "EU Horizon",
    eu_project: "EU Project",
    teaching_title: "Teaching",
    teaching_role: "Navigation Teacher",
    teaching_body: "Navigation teacher at an Italian Istituto Tecnico Trasporti e Logistica (ITTL). Here I share materials, lessons and interactive calculators built for students.",
    teaching_intro_short: "Materials, lessons and interactive calculators for navigation, ship statics and hydrostatics.",
    teaching_subjects: "Subjects & Areas",
    teaching_materials_title: "Materials & Lessons",
    teaching_materials_lead: "Sheets, handouts, exercises and tests grouped by topic. Click an item to open or download.",
    teaching_lessons_lead: "Slides and presentations used in class, grouped by topic. Reference material to follow lessons and review key concepts.",
    teaching_notes_lead: "Concise notes, diagrams and concept maps for independent study and review, organized by topic.",
    teaching_exercises_title: "Exercises",
    teaching_exercises_lead: "Assignments, guided exercises and educational games to practice what you study, grouped by topic.",
    ...
    teaching_calc_lead: "Web apps built for teaching: they open right in the browser, no install needed.",
    teaching_open: "Open",
    ...
    teaching_formulari_lead: "Collection of essential formulas for navigation, ship statics and celestial astronomy.",
    education_title: "Education",
    education_lead: "Academic path at the University of Naples «Parthenope» and advanced training in environmental management.",
    ...
    affiliation_body: "ISSNOVA — Fondazione Institute for Sustainable Society and Innovation. Researcher in transport sustainability.",
    bio_card_title: "Bio",
    lang_switch: "IT"
  }
};
function LangProvider({ children }) {
  ...
  const t = (k) => dict[lang][k] ?? dict.it[k];
...
const Ship = createLucideIcon("ship", __iconNode$1);
const __iconNode = [
  ["path", { d: "M18 6 6 18", key: "1bl5f8" }],
  ["path", { d: "m6 6 12 12", key: "d8bk6v" }]
];
const X = createLucideIcon("x", __iconNode);
const logo = "/assets/logo-BvOrUg74.png";
...
function PortfolioLayout({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "bg-navy-gradient text-white relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 py-6 sm:py-10 md:py-14 flex flex-col md:flex-row items-center gap-5 md:gap-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full flex items-start justify-between md:hidden", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: navOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(X, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, {})
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          motion.div,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "img",
              {
                src: logo,
                alt: "Daniele Palma Esposito — logo",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-center md:justify-start gap-2 mb-4 flex-wrap", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "pill pill-gold inline-flex", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Compass, { size: 12 }),
                  " ",
                  t("badge")
                ] }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "block", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-2xl sm:text-3xl md:text-5xl text-gold-light leading-tight hover:text-gold transition break-words", children: "Daniele Palma Esposito" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-3 text-[11px] sm:text-xs md:text-sm uppercase tracking-wider-2 text-white/75 font-light", children: t("role") }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-5 flex flex-wrap gap-2 justify-center md:justify-start text-xs text-white/70", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { size: 12, className: "text-gold" }),
                  " ",
                  t("location")
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "opacity-40", children: "·" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Ship, { size: 12, className: "text-gold" }),
                  " ISSNOVA"
                ] })
              ] })
            ]
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-4 sm:px-6 flex flex-col md:flex-row gap-6 md:gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "aside",
        {
          className: `${navOpen ? "block" : "hidden"} md:block md:sticky md:top-6 md:self-start md:w-56 shrink-0 pt-4 md:pt-0 md:py-10`,
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "bg-navy text-white rounded-md p-4 border border-gold/30 shadow-soft", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display text-[11px] uppercase tracking-wider-2 text-gold mb-3 px-2", children: t("sidebar_title") }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-1", children: NAV.map(
              (n) => "children" in n ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                NavGroup,
                {
                  label: n.label,
                  items: n.children,
                ...
                Link,
                {
                  ...
                  className: `block px-3 py-2 rounded text-[12px] font-display uppercase tracking-wider-2 transition ${pathname === n.to ? "bg-gold-gradient text-navy font-semibold" : "text-white/80 hover:text-gold-light hover:bg-white/5"}`,
                  children: n.label
                }
              ) }, n.to)
            ) })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 min-w-0 py-10", children })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "bg-navy-gradient text-white/80 mt-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-rule" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-3 text-xs", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display uppercase tracking-wider-2 text-gold-light", children: "Daniele Palma Esposito" }),
...
function NavGroup({
  ...
  const [open, setOpen] = reactExports.useState(anyActive);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        onClick: () => setOpen((v) => !v),
        className: `w-full flex items-center justify-between px-3 py-2 rounded text-[12px] font-display uppercase tracking-wider-2 transition ${anyActive ? "text-gold-light bg-white/5" : "text-white/80 hover:text-gold-light hover:bg-white/5"}`,
        children: [
    ...
    open && /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-1 ml-2 pl-2 border-l border-gold/30 space-y-1", children: items.map((i) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: i.to,
          onClick: onNavigate,
          className: `block px-3 py-1.5 rounded text-[11px] font-display uppercase tracking-wider-2 transition ${active ? "bg-gold-gradient text-navy font-semibold" : "text-white/70 hover:text-gold-light hover:bg-white/5"}`,
          children: i.label
        }
      ) }, i.to);
    }) })
...
function PageHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.div,
    {
      ...
      className: "mb-10",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "section-title text-2xl md:text-3xl mb-3 flex items-center gap-3", children: [
          icon && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { "aria-hidden": true, children: icon }),
          title
        ] }),
        lead && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-ink-muted text-[15px] md:text-base max-w-3xl leading-relaxed", children: lead })
      ]
    }
  );
}
const EDITABLE = {
  ...
  "home.hero.body": {
    page: "Home",
    label: "Testo hero",
    defaultIt: "Materiali, lezioni, calcolatori e formulari per studiare la navigazione, la statica della nave e l'astronomia nautica. Tutto raccolto in un unico posto.",
    defaultEn: "Materials, lessons, calculators and formularies to study navigation, ship statics and celestial astronomy. All gathered in one place.",
    multiline: true
  },
  // CHI SONO
  "about.lead": {
    page: "Chi sono",
    label: "Sottotitolo",
    defaultIt: "Ricercatore presso la Fondazione Institute for Sustainable Society and Innovation (ISSNOVA) e docente di Navigazione.",
    defaultEn: "Researcher at the Fondazione Institute for Sustainable Society and Innovation (ISSNOVA) and Navigation teacher.",
    multiline: true
  },
  "about.p1": {
    page: "Chi sono",
    label: "Bio — paragrafo 1",
    defaultIt: "Sono ricercatore presso la Fondazione Institute for Sustainable Society and Innovation (ISSNOVA) e docente di Navigazione. Ho conseguito la Laurea Magistrale (con lode) in Scienze e Tecnologie della Navigazione all'Università degli Studi di Napoli «Parthenope», con specializzazione in MASS — Maritime Autonomous Surface Ships e navigazione a rotta adattiva.",
    defaultEn: "I am a researcher at the Fondazione Institute for Sustainable Society and Innovation (ISSNOVA) and a Navigation teacher. I earned my M.Sc. (cum laude) in Navigation Sciences and Technologies at the University of Naples «Parthenope», specializing in MASS — Maritime Autonomous Surface Ships and adaptive routing.",
    multiline: true
  },
  "about.p2": {
    page: "Chi sono",
    label: "Bio — paragrafo 2",
    defaultIt: "Nel percorso accademico ho acquisito competenze avanzate in: elaborazione dati GNSS, telerilevamento, navigazione inerziale e sensor fusion. Ho partecipato a diversi progetti europei nel settore marittimo.",
    defaultEn: "My academic path covers GNSS data processing, remote sensing, inertial navigation, and sensor fusion. I have contributed to several European research projects in the maritime sector.",
    multiline: true
  },
  // PROGETTI
  "projects.lead": {
    ...
    label: "Sottotitolo",
    defaultIt: "Partecipazione a progetti Horizon Europe nel cluster Climate, Energy and Mobility (CL5) per il trasporto marittimo a impatto zero.",
    defaultEn: "Participation in Horizon Europe projects under the Climate, Energy and Mobility cluster (CL5) for zero-impact maritime transport.",
    multiline: true
  },
  // FORMAZIONE
  "education.lead": {
    page: "Formazione",
    label: "Sottotitolo",
    defaultIt: "Percorso accademico all'Università degli Studi di Napoli «Parthenope» e formazione avanzata in gestione ambientale.",
    defaultEn: "Academic path at the University of Naples «Parthenope» and advanced training in environmental management.",
    multiline: true
  },
  // CV
  "cv.lead": {
  ...
  "contact.affiliation": {
    page: "Contatti",
    label: "Affiliazione",
    defaultIt: "ISSNOVA — Fondazione Institute for Sustainable Society and Innovation. Ricercatore in sostenibilità dei trasporti.",
    defaultEn: "ISSNOVA — Fondazione Institute for Sustainable Society and Innovation. Researcher in transport sustainability.",
    multiline: true
  }
};
const PageContentCtx = reactExports.createContext(null);
function PageContentProvider({ children }) {
  ...
  const ctx = reactExports.useMemo(() => ({ values, loading, refresh }), [values, loading, refresh]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(PageContentCtx.Provider, { value: ctx, children });
}
function usePageContentCtx() {
  const c = reactExports.useContext(PageContentCtx);
...
const Route$g = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "Daniele Palma Esposito — Docente di Navigazione" },
      { name: "description", content: "Materiali, lezioni, calcolatori e formulari di Navigazione per studenti ITTL." },
      { name: "author", content: "Daniele Palma Esposito" },
      { property: "og:title", content: "Daniele Palma Esposito — Docente di Navigazione" },
      { property: "og:description", content: "Materiali e strumenti per studenti di Navigazione." },
...
function RootComponent() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AuthProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(LangProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PageContentProvider, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PortfolioLayout, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Toaster2, { richColors: true, position: "top-right" })
  ] }) }) }) });
}
const $$splitComponentImporter$e = () => import("./login-DznAHYac.js");
...
const $$splitComponentImporter$d = () => import("./didattica-BSkFkBIG.js");
const Route$e = createFileRoute("/didattica")({
  component: lazyRouteComponent($$splitComponentImporter$d, "component")
});
const $$splitComponentImporter$c = () => import("./cv-DVU7f638.js");
const Route$d = createFileRoute("/cv")({
  head: () => ({
    meta: [{
      title: "CV — Daniele Palma Esposito"
    }, {
      name: "description",
      content: "Curriculum Vitae di Daniele Palma Esposito — Maritime Sustainability Researcher @ ISSNOVA."
    }, {
      property: "og:title",
      content: "CV — Daniele Palma Esposito"
    }, {
      property: "og:description",
      content: "Curriculum sintetico: ricerca, didattica e progetti europei."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$c, "component")
});
const $$splitComponentImporter$b = () => import("./contatti-CesKqfcz.js");
const Route$c = createFileRoute("/contatti")({
  head: () => ({
    meta: [{
      title: "Contatti — Daniele Palma Esposito"
    }, {
      name: "description",
      content: "Contatti per collaborazioni di ricerca e interventi accademici."
    }, {
      property: "og:title",
      content: "Contatti — Daniele Palma Esposito"
    }, {
      property: "og:description",
      content: "Contatti professionali e link LinkedIn."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./chi-sono-HBDsR7D2.js");
const Route$b = createFileRoute("/chi-sono")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./admin-DEM9yo5G.js");
...
const $$splitComponentImporter$8 = () => import("./index-DcWAyKfG.js");
const Route$9 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfolio di Daniele Palma Esposito, ricercatore in sostenibilità dei trasporti presso ISSNOVA e docente di Navigazione."
    }, {
      property: "og:title",
      content: "Daniele Palma Esposito — Navigazione & Ricerca"
    }, {
      property: "og:description",
      content: "Ricercatore in sostenibilità dei trasporti marittimi e docente di Navigazione. Progetti Horizon Europe, GNSS, MASS, Sensor Fusion."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const Route$8 = createFileRoute("/didattica/")({
  beforeLoad: () => {
    throw redirect({ to: "/didattica/lezioni" });
  }
});
const $$splitComponentImporter$7 = () => import("./chi-sono.index-C6haxAju.js");
const Route$7 = createFileRoute("/chi-sono/")({
  head: () => ({
    meta: [{
      title: "Chi Sono — Daniele Palma Esposito"
    }, {
      name: "description",
      content: "Biografia di Daniele Palma Esposito, ricercatore ISSNOVA e docente di Navigazione."
    }, {
      property: "og:title",
      content: "Chi Sono — Daniele Palma Esposito"
    }, {
      property: "og:description",
      content: "Biografia di Daniele Palma Esposito, ricercatore ISSNOVA e docente di Navigazione."
    }]
...
const $$splitComponentImporter$6 = () => import("./didattica.lezioni-ClGmRYhU.js");
const Route$6 = createFileRoute("/didattica/lezioni")({
  head: () => ({
    meta: [{
      title: "Lezioni — Didattica della Navigazione"
    }, {
      name: "description",
      content: "Lezioni e presentazioni per gli studenti dell'ITTL."
    }, {
      property: "og:title",
      content: "Lezioni — Didattica"
    }, {
      property: "og:description",
      content: "Lezioni per gli studenti."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./didattica.formulari-EIbGjCJh.js");
const Route$5 = createFileRoute("/didattica/formulari")({
  head: () => ({
    meta: [{
      title: "Formulari — Didattica della Navigazione"
    }, {
      name: "description",
      content: "Formulari di navigazione, statica della nave e astronomia nautica."
    }, {
      property: "og:title",
      content: "Formulari — Didattica"
    }, {
      property: "og:description",
      content: "Formulari di riferimento."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./didattica.esercitazioni-DQq80DEd.js");
const Route$4 = createFileRoute("/didattica/esercitazioni")({
  head: () => ({
    meta: [{
      title: "Esercitazioni — Didattica della Navigazione"
    }, {
      name: "description",
      content: "Compiti, esercizi guidati e giochi didattici divisi per argomento."
    }, {
      property: "og:title",
      content: "Esercitazioni — Didattica"
    }, {
      property: "og:description",
      content: "Compiti, esercizi e giochi didattici."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./didattica.calcolatori-B7gSsPyP.js");
const Route$3 = createFileRoute("/didattica/calcolatori")({
  head: () => ({
    meta: [{
      title: "Calcolatori — Didattica della Navigazione"
    }, {
      name: "description",
      content: "Calcolatori interattivi per la statica della nave e la navigazione."
    }, {
      property: "og:title",
      content: "Calcolatori — Didattica"
    }, {
      property: "og:description",
      content: "Calcolatori interattivi."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./didattica.appunti-C9eejSeJ.js");
const Route$2 = createFileRoute("/didattica/appunti")({
  head: () => ({
    meta: [{
      title: "Appunti — Didattica della Navigazione"
    }, {
      name: "description",
      content: "Dispense, appunti ed esercizi svolti."
    }, {
      property: "og:title",
      content: "Appunti — Didattica"
    }, {
      property: "og:description",
      content: "Dispense ed esercizi."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./chi-sono.progetti-YNb5Ev4C.js");
const Route$1 = createFileRoute("/chi-sono/progetti")({
  head: () => ({
    meta: [{
      title: "Progetti Europei — AENEAS, FLEXSHIP, OVERHEAT, UnderSec, TRUSTEE"
    }, {
      name: "description",
      content: "Progetti Horizon Europe sul trasporto marittimo sostenibile."
    }, {
      property: "og:title",
      content: "Progetti Europei — Daniele Palma Esposito"
    }, {
      property: "og:description",
      content: "Progetti Horizon Europe sul trasporto marittimo sostenibile."
    }]
...
const $$splitComponentImporter = () => import("./chi-sono.formazione-b5iIifwH.js");
const Route2 = createFileRoute("/chi-sono/formazione")({
  head: () => ({
    meta: [{
      title: "Formazione — Università di Napoli «Parthenope»"
    }, {
      name: "description",
      content: "Percorso accademico in Scienze e Tecnologie della Navigazione, MASS e gestione ambientale."
    }, {
      property: "og:title",
      content: "Formazione — Daniele Palma Esposito"
    }, {
      property: "og:description",
      content: "Percorso accademico e specializzazione in MASS e gestione ambientale."
    }]
  }),
...
const DidatticaRoute = Route$e.update({
  id: "/didattica",
  path: "/didattica",
  getParentRoute: () => Route$g
});
const CvRoute = Route$d.update({
  id: "/cv",
  path: "/cv",
  getParentRoute: () => Route$g
});
const ContattiRoute = Route$c.update({
  id: "/contatti",
  path: "/contatti",
  getParentRoute: () => Route$g
});
const ChiSonoRoute = Route$b.update({
  id: "/chi-sono",
  path: "/chi-sono",
  getParentRoute: () => Route$g
});
...
const DidatticaIndexRoute = Route$8.update({
  id: "/",
  path: "/",
  getParentRoute: () => DidatticaRoute
});
const ChiSonoIndexRoute = Route$7.update({
  id: "/",
  path: "/",
  getParentRoute: () => ChiSonoRoute
});
const DidatticaLezioniRoute = Route$6.update({
  id: "/lezioni",
  path: "/lezioni",
  getParentRoute: () => DidatticaRoute
});
const DidatticaFormulariRoute = Route$5.update({
  id: "/formulari",
  path: "/formulari",
  getParentRoute: () => DidatticaRoute
});
const DidatticaEsercitazioniRoute = Route$4.update({
  id: "/esercitazioni",
  path: "/esercitazioni",
  getParentRoute: () => DidatticaRoute
});
const DidatticaCalcolatoriRoute = Route$3.update({
  id: "/calcolatori",
  path: "/calcolatori",
  getParentRoute: () => DidatticaRoute
});
const DidatticaAppuntiRoute = Route$2.update({
  id: "/appunti",
  path: "/appunti",
  getParentRoute: () => DidatticaRoute
});
const ChiSonoProgettiRoute = Route$1.update({
  id: "/progetti",
  path: "/progetti",
  getParentRoute: () => ChiSonoRoute
});
const ChiSonoFormazioneRoute = Route2.update({
  id: "/formazione",
  path: "/formazione",
  getParentRoute: () => ChiSonoRoute
});
const ChiSonoRouteChildren = {
  ChiSonoFormazioneRoute,
  ChiSonoProgettiRoute,
  ChiSonoIndexRoute
};
const ChiSonoRouteWithChildren = ChiSonoRoute._addFileChildren(ChiSonoRouteChildren);
const DidatticaRouteChildren = {
  DidatticaAppuntiRoute,
  DidatticaCalcolatoriRoute,
  DidatticaEsercitazioniRoute,
  DidatticaFormulariRoute,
  DidatticaLezioniRoute,
  DidatticaIndexRoute
};
