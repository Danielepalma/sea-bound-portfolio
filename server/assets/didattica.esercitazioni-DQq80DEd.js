...
function EsercitazioniPage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PageHeader, { icon: "🎯", title: t("teaching_exercises_title"), lead: t("teaching_exercises_lead") }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MaterialsList, { area: "esercitazioni" })
  ] });
}
export {
  EsercitazioniPage as component
};
